...
public class Eleicao {
    ...
    public static void cadastrarCandidato() {
        int posicaoInsercao = 0; // Posição na matriz na qual o próximo candidato deve ser inserido.

        // Verifica qual é a próxima posição vazia na matriz de candidatos.
        // Se a posição 4 do vetor do candidato for diferente de nulo e igual a 1, sabemos que há um candidato armazenado nela.
